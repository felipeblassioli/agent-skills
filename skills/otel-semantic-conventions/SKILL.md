...
|-------------------------------------|-----------------------------------------------------------------------|-----------------------------------------------------------------|
| [attributes](./references/attributes.md) | Attribute registry, selection, placement, common attributes by domain | Choosing or reviewing attributes; HTTP/DB/messaging/RPC attributes; attribute placement (resource vs span) |
| [versioning](./references/versioning.md) | Semconv versioning, stability, migration                              | Semconv version migration                                       |
| [dash0](./references/dash0.md)           | Dash0 derived attributes and feature dependencies                     | Dash0 derived attributes                                        |

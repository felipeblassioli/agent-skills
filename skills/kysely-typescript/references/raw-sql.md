- Sql < [T](https://kysely-org.github.io/kysely-apidoc/interfaces/#sqlt) \= unknown \> (  
	sqlFragments:TemplateStringsArray,  
	...parameters:unknown \[\],  
	):[RawBuilder](https://kysely-org.github.io/kysely-apidoc/interfaces/RawBuilder.html) < [T](https://kysely-org.github.io/kysely-apidoc/interfaces/#sqlt) \>
	...
	If you need your substitutions to be interpreted as identifiers, value literals or lists of things, see the [Sql.ref](https://kysely-org.github.io/kysely-apidoc/interfaces/#ref), [Sql.table](https://kysely-org.github.io/kysely-apidoc/interfaces/#table), [Sql.id](https://kysely-org.github.io/kysely-apidoc/interfaces/#id),[Sql.lit](https://kysely-org.github.io/kysely-apidoc/interfaces/#lit), [Sql.raw](https://kysely-org.github.io/kysely-apidoc/interfaces/#raw) and [Sql.join](https://kysely-org.github.io/kysely-apidoc/interfaces/#join) functions.
	...
	\`.execute(db)
	```
	Substitutions also handle [ExpressionBuilder.ref](https://kysely-org.github.io/kysely-apidoc/interfaces/ExpressionBuilder.html#ref),[DynamicModule.ref](https://kysely-org.github.io/kysely-apidoc/classes/DynamicModule.html#ref) and pretty much anything else you throw at it. Here's an example of calling a function in a type-safe way:
	```ts
...
- This can be used to add arbitrary identifiers to SQL snippets.
	Does the same thing as [ref](https://kysely-org.github.io/kysely-apidoc/interfaces/#ref) and [table](https://kysely-org.github.io/kysely-apidoc/interfaces/#table) but can also be used for any other identifiers like index names.
	You should use [ref](https://kysely-org.github.io/kysely-apidoc/interfaces/#ref) and [table](https://kysely-org.github.io/kysely-apidoc/interfaces/#table) instead of this whenever possible as they produce a more semantic operation node tree.
...
- This can be used to add lists of things to SQL snippets.
	...
	sql\`, \`
	```
	In addition to values, items in the list can be also [sql](https://kysely-org.github.io/kysely-apidoc/variables/sql.html) expressions, queries or anything else the normal substitutions support:
	```ts
	const things = [
	  123,
	  sql\`(1 == 1)\`,
	...
	- `Optional` separator: [RawBuilder](https://kysely-org.github.io/kysely-apidoc/interfaces/RawBuilder.html) < any \>
	#### Returns RawBuilder<>
...
- This can be used to add literal values to SQL snippets.
	...
	- V
	#### Parameters
	- value: [V](https://kysely-org.github.io/kysely-apidoc/interfaces/#litv)
	#### Returns RawBuilder<>
...
- This can be used to add runtime column references to SQL snippets.
	By default `${}` substitutions in [sql](https://kysely-org.github.io/kysely-apidoc/variables/sql.html) template strings get transformed into parameters. You can use this function to tell Kysely to interpret them as column references instead.
	WARNING! Using this with unchecked inputs WILL lead to SQL injection vulnerabilities. The input is not checked or escaped by Kysely in any way.
	```ts
...
- table < [T](https://kysely-org.github.io/kysely-apidoc/interfaces/#tablet) \= unknown \> (tableReference:string):[RawBuilder](https://kysely-org.github.io/kysely-apidoc/interfaces/RawBuilder.html) < [T](https://kysely-org.github.io/kysely-apidoc/interfaces/#tablet) \>
	This can be used to add runtime table references to SQL snippets.
	By default `${}` substitutions in [sql](https://kysely-org.github.io/kysely-apidoc/variables/sql.html) template strings get transformed into parameters. You can use this function to tell Kysely to interpret them as table references instead.
	WARNING! Using this with unchecked inputs WILL lead to SQL injection vulnerabilities. The input is not checked or escaped by Kysely in any way.
	```ts
	const table = 'person'
...
- `sql.val(value)` is a shortcut for:
	...
	- V
	#### Parameters
	- value: [V](https://kysely-org.github.io/kysely-apidoc/interfaces/#valv)

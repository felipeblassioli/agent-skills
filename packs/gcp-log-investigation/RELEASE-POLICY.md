...
`gcp-log-investigation` is expected to evolve. Releases should leave behind
durable artifacts that explain what changed, how it was verified, and what still
needs work.
...
When the change affects behavior, prompts, or safety guidance, also record:
...
- non-breaking rule or guide clarifications
...
- new pack artifacts
- new supported workflows or platforms
- materially improved investigation heuristics
- additional profile capabilities that remain backward compatible
...
- artifact removals or major behavior changes
